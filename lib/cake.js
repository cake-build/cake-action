...
class CakeTool {
    ...
    static runScript(scriptPath, toolDirectory) {
        return __awaiter(this, void 0, void 0, function* () {
            const cakeToolPath = yield CakeTool.resolveCakeToolPath(toolDirectory);
            const exitCode = yield exec_1.exec(cakeToolPath, [scriptPath]);
            if (exitCode != 0) {
                throw new Error(`Failed to run the build script. Exit code: ${exitCode}`);
            }
        });
    }
    static resolveCakeToolPath(toolDirectory) {
        return __awaiter(this, void 0, void 0, function* () {
            return toolDirectory ? toolDirectory.appendFileName(dotnetCake) : yield io_1.which(dotnetCake);
        });
    }
}
